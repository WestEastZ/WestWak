    ...
    <div className="w-full">
      ...
      >
        <section className="flex w-full items-center justify-center gap-2 max-md:flex-col">
          ...
          {/* input */}
          <div className="flex w-full items-center justify-center gap-2 max-md:border-b max-md:border-customColor-border">
            <CheckBoxLock
            ...
            <textarea
              ...
              rows={1}
              className="h-12 min-h-[3rem] w-full resize-none overflow-hidden bg-inherit py-2 pl-4 leading-6 text-white outline-none focus:border-customColor-main md:border-b md:border-customColor-border"
