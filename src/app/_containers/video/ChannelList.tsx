import { ChannelVideos, VideoData, VideoInfo } from "@/app/_types/type";
      ...
      {Object.entries(channels).map(([channelsName, channelsInfo]) => (
        <section key={channelsName} className="flex flex-col gap-5">
          <div className="flex items-center gap-3">
            <ProfileImage thumbnail={channelsInfo.channelThumbnail} />
            <h2 className="font-bold text-2xl">{channelsName}</h2>
          </div>
